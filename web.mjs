    ...
    (function ($$) {
        class $giper_baza_flex_field extends $.$giper_baza_flex_field {
            ...
            list_pick(next) {
                if (!next)
                    return null;
                this.pawn(next)?.cast($giper_baza_list).add(next);
                return null;
            }
            list_item_add() {
                const target = this.pawn(null).cast($giper_baza_list_link.to(() => $giper_baza_flex_subj)).make(null);
        ...
        __decorate([
            $mol_mem
        ], $giper_baza_flex_field.prototype, "list_tools", null);
        __decorate([
            $mol_action
...
;
	($.$giper_baza_flex_form) = class $giper_baza_flex_form extends ($.$mol_list) {
		...
		Field(id){
			const obj = new this.$.$mol_expander();
			(obj.title) = () => ((this.field_name(id)));
			(obj.expanded) = (next) => ((this.field_expanded(id, next)));
	...
	($mol_mem_key(($.$giper_baza_flex_form.prototype), "field_expanded"));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($giper_baza_flex_form, {
            gap: $mol_gap.block,
            Field: {
                background: {
                    color: $mol_theme.card,
...
(function ($) {
    ...
    $.$bog_feedback2_master = $.$bog_feedback2_masters[0];
...
;
	($.$bog_feedback2_board) = class $bog_feedback2_board extends ($.$mol_book2) {
		Theme(){
		...
		Project_note(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.project_note(id)));
			return obj;
		}
		Project_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"project": (this.project_id(id))});
			(obj.sub) = () => ([(this.Project_name(id)), (this.Project_note(id))]);
			return obj;
		}
		project_rows(){
			return [(this.Project_link("0"))];
		}
		Projects(){
			const obj = new this.$.$mol_list();
		...
		Registry_note(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.registry_note()));
			return obj;
		}
		Menu(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_feedback2_board_Menu_title")));
			(obj.tools) = () => ([(this.Status())]);
			(obj.body) = () => ((this.menu_body()));
			(obj.foot) = () => ([(this.Registry_note())]);
			return obj;
		}
		project(){
			return "";
		...
		Project(){
			const obj = new this.$.$bog_feedback2_board_project();
			(obj.project_id) = () => ((this.project()));
			(obj.land_links) = () => ((this.project_land_links()));
			return obj;
		}
		registry_link(){
			return "";
		...
		pages(){
			return [(this.Menu()), (this.Project())];
		}
		Projects_empty(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_feedback2_board_Projects_empty_title")));
			return obj;
		}
		Placeholder(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_feedback2_board_Placeholder_title")));
			return obj;
		}
	};
	($mol_mem(($.$bog_feedback2_board.prototype), "Theme"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Status"));
	($mol_mem_key(($.$bog_feedback2_board.prototype), "Project_name"));
	($mol_mem_key(($.$bog_feedback2_board.prototype), "Project_note"));
	($mol_mem_key(($.$bog_feedback2_board.prototype), "Project_link"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Projects"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Registry_note"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Menu"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Project"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Projects_empty"));
	($mol_mem(($.$bog_feedback2_board.prototype), "Placeholder"));
	($.$bog_feedback2_board_project) = class $bog_feedback2_board_project extends ($.$mol_page) {
		Close_icon(){
			const obj = new this.$.$mol_icon_close();
			return obj;
		}
		...
		Entry_reply(id){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.entry_reply(id)));
			return obj;
		}
		entry_content(id){
			return [(this.Entry_text(id)), (this.Entry_reply(id))];
		}
		Entry(id){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ((this.entry_title(id)));
			(obj.content) = () => ((this.entry_content(id)));
			return obj;
		}
		entry_rows(){
			return [(this.Entry("0"))];
		...
		body(){
			return (this.project_body());
		}
		foot(){
			return [(this.Lands_note())];
		}
		Entries_empty(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_feedback2_board_project_Entries_empty_title")));
			return obj;
		}
		Lands_missing(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_feedback2_board_project_Lands_missing_title")));
			return obj;
		}
	};
	($mol_mem(($.$bog_feedback2_board_project.prototype), "Close_icon"));
	($mol_mem(($.$bog_feedback2_board_project.prototype), "Close"));
	($mol_mem_key(($.$bog_feedback2_board_project.prototype), "Entry_text"));
	($mol_mem_key(($.$bog_feedback2_board_project.prototype), "Entry_reply"));
	($mol_mem_key(($.$bog_feedback2_board_project.prototype), "Entry"));
	($mol_mem(($.$bog_feedback2_board_project.prototype), "Entries"));
	($mol_mem(($.$bog_feedback2_board_project.prototype), "Lands_note"));
	($mol_mem(($.$bog_feedback2_board_project.prototype), "Entries_empty"));
	($mol_mem(($.$bog_feedback2_board_project.prototype), "Lands_missing"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $giper_baza_yard.masters_default.splice(0, $giper_baza_yard.masters_default.length, ...master_pin ? [decodeURIComponent(master_pin)] : $bog_feedback2_masters);
        if (master_pin)
            $giper_baza_yard.masters = () => [decodeURIComponent(master_pin)];
        ...
        class $bog_feedback2_board extends $.$bog_feedback2_board {
        ...
        __decorate([
            $mol_mem
        ], $bog_feedback2_board.prototype, "project_ids", null);
        __decorate([
            $mol_mem_key
        ], $bog_feedback2_board.prototype, "land_links", null);
        $$.$bog_feedback2_board = $bog_feedback2_board;
        class $bog_feedback2_board_project extends $.$bog_feedback2_board_project {
            entries_dict(land_link) {
            ...
            refs() {
                ...
                return dated
                    ...
                    .map(([land_link, lord]) => [land_link, lord]);
            }
            project_body() {
                if (!this.land_links().length)
                    return [this.Lands_missing()];
                if (!this.refs().length)
                    return [this.Entries_empty()];
                return [this.Entries()];
            }
            entry_rows() {
        ...
        __decorate([
            $mol_mem
        ], $bog_feedback2_board_project.prototype, "refs", null);
        $$.$bog_feedback2_board_project = $bog_feedback2_board_project;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
